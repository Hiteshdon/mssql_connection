...
#define SQLODBC_FILE_NAME_VER_ANSI              "msodbcsql18"
#define SQLODBC_FILE_NAME_FULL_ANSI             "msodbcsql18.dll"

#define SQLODBC_PRODUCT_NAME_FULL_VER_UNICODE   L"Microsoft ODBC Driver 18 for SQL Server"
#define SQLODBC_PRODUCT_NAME_FULL_UNICODE       L"Microsoft ODBC Driver for SQL Server"
#define SQLODBC_PRODUCT_NAME_SHORT_VER_UNICODE  L"ODBC Driver 18 for SQL Server"

#define SQLODBC_PRODUCT_NAME_SHORT_UNICODE      L"ODBC Driver for SQL Server"

#define SQLODBC_FILE_NAME_UNICODE               L"msodbcsql"
#define SQLODBC_FILE_NAME_VER_UNICODE           L"msodbcsql18"
#define SQLODBC_FILE_NAME_FULL_UNICODE          L"msodbcsql18.dll"
...
#define SQL_COPT_SS_LONGASMAX                       (SQL_COPT_SS_BASE_ADD + 3) /* Flag to set if LONG items should be sent as MAX items */
#define SQL_COPT_SS_GETDATA_EXTENSIONS              (SQL_COPT_SS_BASE_ADD + 4) /* Flag to set if GetData Extensions should be enabled */
#define SQL_COPT_SS_ADD_MAX_USED                    SQL_COPT_SS_GETDATA_EXTENSIONS 
...
#define BCP_OUT_NATIVE_MODE         0x04
    /* BCP encrypt options */
#define BCP_ENCRYPT_OFF         0
#define BCP_ENCRYPT_ON          1
#define BCP_ENCRYPT_STRICT      2
